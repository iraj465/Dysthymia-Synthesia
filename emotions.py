...
while cap.isOpened(): # True:
    ...
    for face_coordinates in faces:
        ...
        if emotion_text == 'angry':
            ...
            top = tkinter.Tk()
            canvas = Canvas(top, width=650, height=650)
            canvas.pack(fill=BOTH, expand=True)
            canvas.create_text(350, 50, text='ME781 Project', font=('Helvetica', 21, 'bold'), justify='center',
                               fill='black')
            canvas.create_text(350, 80, text='Detected emotion is :', font=('Helvetica', 21, 'bold'), justify='center',
            fill='green')
            
            canvas.create_text(350, 550, text='Playing songs of type: SOFT INSTRUMENTAL', font=('Helvetica', 15, 'bold'), justify='center',
            fill='green')
            ...
            img.image = render
            img.place(x=180, y=150)
            top.after(5000, lambda: top.destroy())  # Destroy the widget after 30 seconds
            top.mainloop()
            top.mainloop()
            ...
            canvas = Canvas(top, width=650, height=650)
            canvas.pack(fill=BOTH, expand=True)
            canvas.create_text(350, 55, text='ME781 Project', font=('Helvetica', 21, 'bold'), justify='center',
                    fill='black')
            canvas.create_text(350, 80, text='Detected emotion is :', font=('Helvetica', 21, 'bold'), justify='center',
            fill='green')
            canvas.create_text(350, 550, text='Playing songs of type: FEEL GOOD', font=('Helvetica', 15, 'bold'), justify='center',
            fill='green')
            canvas.update
            ...
            canvas = Canvas(top, width=650, height=650)
            canvas.pack(fill=BOTH, expand=True)
            canvas.create_text(350, 55, text='ME781 Project', font= ('Helvetica', 21, 'bold'), justify='center', fill='black')
            canvas.create_text(350, 80, text='Detected emotion is :', font=('Helvetica', 21, 'bold'), justify='center',fill='green')
            canvas.create_text(350, 550, text='Playing songs of type: SOOTHING & MOTIVATIONAL', font=('Helvetica', 15, 'bold'), justify='center',fill='green')
            canvas.update
            ...
            canvas.create_text(350, 80, text='Detected emotion is :', font=('Helvetica', 21, 'bold'), justify='center',
            fill='green')
            canvas.create_text(350, 550, text='Playing songs of type: INSTRUMENTAL', font=('Helvetica', 15, 'bold'), justify='center',fill='green')
            canvas.update
